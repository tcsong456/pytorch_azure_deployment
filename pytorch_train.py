...
def train_model(model, criterion, optimizer, scheduler, num_epochs, data_dir):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            run.parent.log('best_val_acc',np.float(best_acc))
...
def main():
    ...
    parser.add_argument('--data-path',type=str,help='the path to the stored data')
    parser.add_argument('--model-name',type=str,default='pytorch_model.pt')
    args = parser.parse_args()

#    print("data directory is: " + args.data_path)
